...
const consonantRows: Row[] = [
  ...
  ["ㅅ", "s", "시옷 ชีอด", "ซ · เจอ ㅣ ㅟ = ช", "ต้นคำ = ซ · เมื่อเจอสระ ㅣ ㅟ = ช · ตัวสะกด = แม่กด", "รูปฟันสองซี่ · ชื่อตัวอักษรเองก็อ่าน ชีอด ไม่ใช่ ซีอด"],
  ["ㅇ", "– / ng", "이응 อีอึง", "อ / ง", "ต้นคำ = ไม่มีเสียงเป็นของตัวเอง ออกเสียงตามสระที่เจอ · ตัวสะกด = แม่กง", "วงกลม = ลำคอที่เปิดโล่ง"],
  ["ㅈ", "j", "지읒 ชีอึด", "ช → จ", "พยางค์แรก = ช · พยางค์ที่ 2+ = จ · ตัวสะกด = แม่กด", "ㅅ + หมวก = ลมถูกกักก่อนเสียดสี"],
  ["ㅊ", "ch", "치읓 ชี่อึด", "ช", "ต้นคำ = ช · ตัวสะกด = แม่กด", "ㅈ + ขีด = พ่นลมออกแรง"],
  ["ㅋ", "k", "키읔 คี่อึก", "ค", "ต้นคำ = ค · ตัวสะกด = แม่กก", "ㄱ + ขีด = พ่นลมออกแรง"],
  ["ㅌ", "t", "티읕 ที่อึด", "ท", "ต้นคำ = ท · ตัวสะกด = แม่กด", "ㄷ + ขีด = พ่นลมออกแรง"],
  ["ㅍ", "p", "피읖 พี่อึบ", "พ", "ต้นคำ = พ · ตัวสะกด = แม่กบ", "ㅂ ที่ล้มลง = พ่นลมออกแรง"],
  ...
  ["ㅆ", "ss", "쌍시옷 ซังชีอด", "ซ (เกร็งคอ)", "เป็นได้ทั้งต้นคำและตัวสะกด · เมื่อเจอสระ ㅣ ㅟ = ช · ตัวสะกด = แม่กด", "ㅅ สองตัว = เสียดสีแรงและสั้น"],
