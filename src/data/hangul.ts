...
const consonantRows: Row[] = [
  ...
  ["ㄱ", "g / k", "기역 คีย็อก", "ค → ก", 2, ["เส้นลงขวา", "หักลงล่าง"], "พยางค์แรก = ค · พยางค์ที่ 2+ = ก · ตัวสะกด = แม่กก", "รูปโคนลิ้นยกชิดเพดานอ่อน เหมือนขวานหักมุม"],
  ["ㄴ", "n", "니은 นีอึน", "น", 2, ["เส้นลงล่าง", "เส้นไปขวา"], "ต้นคำ = น · ตัวสะกด = แม่กน", "รูปปลายลิ้นแตะเหงือกหลังฟันบน"],
  ["ㄷ", "d / t", "디귿 ทีกึด", "ท → ด", 3, ["เส้นบน", "เส้นซ้ายลง", "เส้นล่าง"], "พยางค์แรก = ท · พยางค์ที่ 2+ = ด · ตัวสะกด = แม่กด", "ㄴ + หลังคา = ปิดลมแล้วปล่อย"],
  ["ㄹ", "r / l", "리을 รีอึล", "ร / ล", 5, ["เส้นบนขวา", "หักลง", "เส้นกลาง", "หักลง", "เส้นล่าง"], "ต้นคำ = ร · ตัวสะกด = แม่กล", "ㄴ ซ้อนซิกแซก = ลิ้นสะบัดม้วน"],
  ["ㅁ", "m", "미음 มีอึม", "ม", 3, ["เส้นซ้ายลง", "เส้นบนไปขวาแล้วลง", "เส้นล่าง"], "ต้นคำ = ม · ตัวสะกด = แม่กม", "สี่เหลี่ยม = ปากที่ปิดสนิท"],
  ["ㅂ", "b / p", "비읍 พีอึบ", "พ → บ", 4, ["เส้นซ้าย", "เส้นขวา", "เส้นกลาง", "เส้นล่าง"], "พยางค์แรก = พ · พยางค์ที่ 2+ = บ · ตัวสะกด = แม่กบ", "ㅁ ที่เปิดฝาบน = ถ้วยเปิดปาก"],
  ["ㅅ", "s", "시옷 ชีอด", "ซ · เจอ ㅣ ㅟ = ช", 2, ["เส้นเฉียงซ้าย", "เส้นเฉียงขวา"], "ต้นคำ = ซ · เมื่อเจอสระ ㅣ ㅟ = ช · ตัวสะกด = แม่กด", "รูปฟันสองซี่ · ชื่อตัวอักษรเองก็อ่าน ชีอด ไม่ใช่ ซีอด"],
  ["ㅇ", "– / ng", "이응 อีอึง", "อ / ง", 1, ["วงกลมทวนเข็ม"], "ต้นคำ = ไม่มีเสียงเป็นของตัวเอง ออกเสียงตามสระที่เจอ · ตัวสะกด = แม่กง", "วงกลม = ลำคอที่เปิดโล่ง"],
  ["ㅈ", "j", "지읒 ชีอึด", "ช → จ", 3, ["เส้นบน", "เฉียงซ้าย", "เฉียงขวา"], "พยางค์แรก = ช · พยางค์ที่ 2+ = จ · ตัวสะกด = แม่กด", "ㅅ + หมวก = ลมถูกกักก่อนเสียดสี"],
  ["ㅊ", "ch", "치읓 ชี่อึด", "ช", 4, ["ขีดบน", "เส้นขวาง", "เฉียงซ้าย", "เฉียงขวา"], "ต้นคำ = ช · ตัวสะกด = แม่กด", "ㅈ + ขีด = พ่นลมออกแรง"],
  ["ㅋ", "k", "키읔 คี่อึก", "ค", 3, ["เส้นบน", "หักลง", "ขีดกลาง"], "ต้นคำ = ค · ตัวสะกด = แม่กก", "ㄱ + ขีด = พ่นลมออกแรง"],
  ["ㅌ", "t", "티읕 ที่อึด", "ท", 4, ["เส้นบน", "เส้นซ้าย", "ขีดกลาง", "เส้นล่าง"], "ต้นคำ = ท · ตัวสะกด = แม่กด", "ㄷ + ขีด = พ่นลมออกแรง"],
  ["ㅍ", "p", "피읖 พี่อึบ", "พ", 4, ["เส้นบน", "ขาซ้าย", "ขาขวา", "เส้นล่าง"], "ต้นคำ = พ · ตัวสะกด = แม่กบ", "ㅂ ที่ล้มลง = พ่นลมออกแรง"],
  ["ㅎ", "h", "히읗 ฮีอึด", "ฮ", 3, ["ขีดบน", "เส้นขวาง", "วงกลม"], "ต้นคำ = ฮ · ตัวสะกด = แม่กด", "ㅇ + หมวก = ลมหายใจออกจากคอ"],

  // ---- พยัญชนะคู่ 5 ตัว (쌍 = คู่) ----
  ["ㄲ", "kk", "쌍기역 ซังกีย็อก", "ก (เกร็งคอ)", 4, ["ㄱ ตัวแรก", "ㄱ ตัวที่สอง"], "เป็นได้ทั้งต้นคำและตัวสะกด · ตัวสะกด = แม่กก", "ㄱ สองตัว = เกร็งคอแล้วดีดออก ไม่มีลม"],
  ["ㄸ", "tt", "쌍디귿 ซังดีกึด", "ต (เกร็งคอ)", 6, ["ㄷ ตัวแรก", "ㄷ ตัวที่สอง"], "ต้นคำเท่านั้น (เป็นตัวสะกดไม่ได้)", "ㄷ สองตัว = เกร็งคอแล้วดีดออก"],
  ["ㅃ", "pp", "쌍비읍 ซังบีอึบ", "ป (เกร็งคอ)", 8, ["ㅂ ตัวแรก", "ㅂ ตัวที่สอง"], "ต้นคำเท่านั้น (เป็นตัวสะกดไม่ได้)", "ㅂ สองตัว = เกร็งคอแล้วดีดออก"],
  ["ㅆ", "ss", "쌍시옷 ซังชีอด", "ซ (เกร็งคอ)", 4, ["ㅅ ตัวแรก", "ㅅ ตัวที่สอง"], "เป็นได้ทั้งต้นคำและตัวสะกด · เมื่อเจอสระ ㅣ ㅟ = ช · ตัวสะกด = แม่กด", "ㅅ สองตัว = เสียดสีแรงและสั้น"],
  ["ㅉ", "jj", "쌍지읒 ซังจีอึด", "จ (เกร็งคอ)", 6, ["ㅈ ตัวแรก", "ㅈ ตัวที่สอง"], "ต้นคำเท่านั้น (เป็นตัวสะกดไม่ได้)", "ㅈ สองตัว = เกร็งคอแล้วดีดออก"],
];

const vowelRows: Row[] = [
  // ---- สระเดี่ยว (단모음) 10 ตัว, in the PDF's order ----
  ["ㅏ", "a", "아 อา", "อา", 2, ["เส้นตั้ง", "ขีดขวา"], "เขียนไว้ขวาพยัญชนะ", "ขีดชี้ออกขวา = สว่าง (สระแนวตั้ง)"],
  ["ㅑ", "ya", "야 ยา", "ยา", 3, ["เส้นตั้ง", "ขีดบน", "ขีดล่าง"], "เขียนไว้ขวาพยัญชนะ", "ㅏ สองขีด = เติมเสียง ย ข้างหน้า"],
  ["ㅓ", "eo", "어 ออ", "ออ", 2, ["ขีดซ้าย", "เส้นตั้ง"], "เขียนไว้ขวาพยัญชนะ", "ขีดชี้เข้าใน = มืด · อย่าห่อปาก ถ้าห่อจะกลายเป็น ㅗ ทันที"],
  ["ㅕ", "yeo", "여 ยอ", "ยอ", 3, ["ขีดบน", "ขีดล่าง", "เส้นตั้ง"], "เขียนไว้ขวาพยัญชนะ", "ㅓ สองขีด = เติมเสียง ย ข้างหน้า · อย่าห่อปาก ไม่งั้นจะเป็น ㅛ"],
  ["ㅗ", "o", "오 โอ", "โอ", 2, ["ขีดตั้ง", "เส้นนอน"], "เขียนไว้ใต้พยัญชนะ", "ขีดชี้ขึ้น = สว่าง (สระแนวนอน)"],
  ["ㅛ", "yo", "요 โย", "โย", 3, ["ขีดซ้าย", "ขีดขวา", "เส้นนอน"], "เขียนไว้ใต้พยัญชนะ", "ㅗ สองขีด = เติมเสียง ย ข้างหน้า"],
  ["ㅜ", "u", "우 อู", "อู", 2, ["เส้นนอน", "ขีดลง"], "เขียนไว้ใต้พยัญชนะ", "ขีดชี้ลง = มืด (สระแนวนอน)"],
  ["ㅠ", "yu", "유 ยู", "ยู", 3, ["เส้นนอน", "ขีดซ้าย", "ขีดขวา"], "เขียนไว้ใต้พยัญชนะ", "ㅜ สองขีด = เติมเสียง ย ข้างหน้า"],
  ["ㅡ", "eu", "으 อือ", "อือ", 1, ["เส้นนอน"], "เขียนไว้ใต้พยัญชนะ", "เส้นนอน = พื้นดิน ปากแบนกว้าง · ตรงกับ อือ ของไทยพอดี"],
  ["ㅣ", "i", "이 อี", "อี", 1, ["เส้นตั้ง"], "เขียนไว้ขวาพยัญชนะ", "เส้นตั้ง = คนยืนตรง"],

  // ---- สระประสม (이중모음) 11 ตัว, in the PDF's order ----
  ["ㅔ", "e", "에 เอ", "เอ", 3, ["ขีดซ้าย", "เส้นตั้ง", "เส้นตั้งขวา"], "เขียนไว้ขวาพยัญชนะ", "ㅓ + ㅣ (ฟังแทบไม่ต่างจาก ㅐ)"],
  ["ㅖ", "ye", "예 เย", "เย", 4, ["ㅕ", "เส้นตั้งขวา"], "เขียนไว้ขวาพยัญชนะ", "ㅕ + ㅣ = ㅔ ที่มีเสียง ย"],
  ["ㅐ", "ae", "애 แอ", "แอ", 3, ["เส้นตั้ง", "ขีดขวา", "เส้นตั้งขวา"], "เขียนไว้ขวาพยัญชนะ", "ㅏ + ㅣ (คนเกาหลีรุ่นใหม่ออกเสียงเกือบเท่า ㅔ)"],
  ["ㅒ", "yae", "얘 แย", "แย", 4, ["ㅑ", "เส้นตั้งขวา"], "เขียนไว้ขวาพยัญชนะ", "ㅑ + ㅣ = ㅐ ที่มีเสียง ย"],
  ["ㅘ", "wa", "와 วา", "วา", 4, ["ㅗ", "ㅏ"], "เขียนไว้ใต้และขวา", "ㅗ + ㅏ = ว + อา"],
  ["ㅙ", "wae", "왜 แว", "แว", 5, ["ㅗ", "ㅐ"], "เขียนไว้ใต้และขวา", "ㅗ + ㅐ = ว + แอ"],
  ["ㅚ", "oe", "외 เว", "เว", 3, ["ㅗ", "ㅣ"], "เขียนไว้ใต้และขวา", "ㅗ + ㅣ = ว + เอ"],
  ["ㅝ", "wo", "워 วอ", "วอ", 4, ["ㅜ", "ㅓ"], "เขียนไว้ใต้และขวา", "ㅜ + ㅓ = ว + ออ · ตัว ออ ไม่ห่อปาก เหมือน ㅓ"],
  ["ㅞ", "we", "웨 อุเว", "อุเว", 5, ["ㅜ", "ㅔ"], "เขียนไว้ใต้และขวา", "ㅜ + ㅔ = อุ + เว"],
  ["ㅟ", "wi", "위 วี", "วี", 3, ["ㅜ", "ㅣ"], "เขียนไว้ใต้และขวา", "ㅜ + ㅣ = ว + อี"],
  ["ㅢ", "ui", "의 อึย", "อึย", 2, ["ㅡ", "ㅣ"], "ไม่มีพยัญชนะต้น + พยางค์แรก = อึย · มีพยัญชนะต้น = อี · ไม่ใช่พยางค์แรกและไม่มีพยัญชนะต้น = อี หรือ อึย · เป็นไวยากรณ์แสดงความเป็นเจ้าของ = เอ", "의사 = อึยซา (หมอ) · 흰색 = ฮีนแซ็ก (สีขาว) · 회의 = ฮเวอึย หรือ ฮเวอี (การประชุม)"],
];
