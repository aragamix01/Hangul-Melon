...
const consonantRows: Row[] = [
  ...
  ["ㅅ", "s", "시옷 siot", "ซ · หน้า ㅣ = ช", 2, ["เส้นเฉียงซ้าย", "เส้นเฉียงขวา"], "ต้นคำ = ซ · หน้า ㅣ ㅑ ㅕ ㅛ ㅠ = ช · ตัวสะกด = ท", "รูปฟันสองซี่ · 시 อ่าน ชี ไม่ใช่ ซี — เจอบ่อยมากในคำว่า 시간 씨 아니에요"],
  ...
  ["ㅆ", "ss", "쌍시옷 ssangsiot", "ซ (เกร็งคอ)", 4, ["ㅅ ตัวแรก", "ㅅ ตัวที่สอง"], "เป็นได้ทั้งต้นคำและตัวสะกด · หน้า ㅣ = ช เหมือน ㅅ", "ㅅ สองตัว = เสียดสีแรงและสั้น · 씨 อ่าน ชี"],
...
const vowelRows: Row[] = [
  ...
  ["ㅓ", "eo", "어 eo", "ออ (ปากไม่ห่อ)", 2, ["ขีดซ้าย", "เส้นตั้ง"], "เขียนไว้ขวาพยัญชนะ", "ขีดชี้เข้าใน = มืด · อย่าห่อปาก ถ้าห่อจะกลายเป็น ㅗ ทันที — จุดผิดที่คนไทยพลาดบ่อยที่สุด"],
  ...
  ["ㅡ", "eu", "으 eu", "อือ", 1, ["เส้นนอน"], "เขียนไว้ใต้พยัญชนะ", "เส้นนอน = พื้นดิน ปากแบนกว้าง · ตรงกับ อือ ของไทยพอดี ข้อได้เปรียบของคนไทย ฝรั่งออกเสียงนี้ไม่ได้"],
  ...
  ["ㅕ", "yeo", "여 yeo", "ยอ (ปากไม่ห่อ)", 3, ["ขีดบน", "ขีดล่าง", "เส้นตั้ง"], "เขียนไว้ขวาพยัญชนะ", "ㅓ สองขีด = เติมเสียง ย ข้างหน้า · อย่าห่อปาก ไม่งั้นจะเป็น ㅛ"],
  ...
  ["ㅙ", "wae", "왜 wae", "เว", 5, ["ㅗ", "ㅐ"], "เขียนไว้ใต้และขวา", "ㅗ + ㅐ — ปัจจุบันเสียงเท่ากับ ㅚ ㅞ ทุกตัว ต่างแค่ตอนเขียน"],
  ["ㅚ", "oe", "외 oe", "เว", 3, ["ㅗ", "ㅣ"], "เขียนไว้ใต้และขวา", "ㅗ + ㅣ — ปัจจุบันเสียงเท่ากับ ㅙ ㅞ ทุกตัว ต่างแค่ตอนเขียน"],
  ["ㅝ", "wo", "워 wo", "วอ (ปากไม่ห่อ)", 4, ["ㅜ", "ㅓ"], "เขียนไว้ใต้และขวา", "ㅜ + ㅓ = ว + ออ · ตัว ออ ไม่ห่อปาก เหมือน ㅓ"],
  ["ㅞ", "we", "웨 we", "เว", 5, ["ㅜ", "ㅔ"], "เขียนไว้ใต้และขวา", "ㅜ + ㅔ — ㅙ ㅚ ㅞ เสียงเดียวกันหมด จำที่คำ ไม่ต้องแยกที่เสียง"],
  ["ㅟ", "wi", "위 wi", "วี", 3, ["ㅜ", "ㅣ"], "เขียนไว้ใต้และขวา", "ㅜ + ㅣ = ว + อี"],
  ["ㅢ", "ui", "의 ui", "อึย", 2, ["ㅡ", "ㅣ"], "พยางค์แรก = อึย · ไม่ใช่พยางค์แรก = อ่านเป็น ㅣ · เป็นคำช่วยแสดงเจ้าของ = อ่านเป็น ㅔ", "ㅡ + ㅣ ออกเร็ว ๆ ติดกัน · 의사 = อึยซา แต่ 회의 = ฮเวอี"],
];
